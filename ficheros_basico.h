...
#define AZUL "\x1b[34m"
#define LILA "\x1b[35m"
#define DEBUGN2 0  // leer_sf.c
#define DEBUGN3 0  // leer_sf.c, leer_bit()
#define DEBUGN4 0  // traducir_bloque_inodo()
#define DEBUGN5 0  // traducir_bloque_inodo()
#define DEBUGN6 0  // traducir_bloque_inodo(), liberar_bloques_inodo()
...
int liberar_bloque_punteros(int nbloque, int nivel, int blinicial, int primerBL, int* breads, int* bwrites); // Auxiliar a liberar_bloques_inodo
